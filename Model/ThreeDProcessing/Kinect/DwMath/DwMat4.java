...
package Polygen.Model.ThreeDProcessing.Kinect.DwMath;
...
public class DwMat4 {
  ...
  */
  ...
  public static void perspective_ref(float fovy, float aspect, float n, float f, float[] dst_m4) {
    fovy *= (Math.PI / 360.0);
    float cot = (float) -Math.tan(90 - fovy/2);
    float nf = (n - f);
...
//    dst_m4[3] = 0;    dst_m4[7] = 0;     dst_m4[11] = -1;            dst_m4[15] = 0;
  ...
  public static String toStr(float[] m4, int prec) {
    String line1 = String.format(Locale.ENGLISH, "[%+3.3f, %+3.3f, %+3.3f, %+3.3f]", m4[0], m4[4], m4[ 8], m4[12]);
    String line2 = String.format(Locale.ENGLISH, "[%+3.3f, %+3.3f, %+3.3f, %+3.3f]", m4[1], m4[5], m4[ 9], m4[13]);
    String line3 = String.format(Locale.ENGLISH, "[%+3.3f, %+3.3f, %+3.3f, %+3.3f]", m4[2], m4[6], m4[10], m4[14]);
    String line4 = String.format(Locale.ENGLISH, "[%+3.3f, %+3.3f, %+3.3f, %+3.3f]", m4[3], m4[7], m4[11], m4[15]);
